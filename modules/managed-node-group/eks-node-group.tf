...
#  scaling_config {
#    desired_size = var.node_group_scaling_config.desired_capacity
#    max_size     = var.node_group_scaling_config.max_capacity
#    min_size     = var.node_group_scaling_config.min_capacity
#  }
#}
