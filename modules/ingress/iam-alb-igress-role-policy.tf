resource "aws_iam_policy" "ALBIngressControllerIAMPolicy" {
  ...
  name   = "pol-glob-${var.environment}-${var.cost_centre}-${var.app_service}albIngCntrl-${var.random_suffix_string}-${var.seq_id}"
  policy = <<POLICY
{
  "Version": "2012-10-17",
  "Statement": [
...
resource "aws_iam_role" "eks_alb_ingress_controller" {
  count  = var.enable_ingress_config ? 1 : 0
  name = "rol-glob-${var.environment}-${var.cost_centre}-${var.app_service}albIngCntrl-${var.random_suffix_string}-${var.seq_id}"
...
resource "aws_iam_role_policy_attachment" "ALBIngressControllerIAMPolicy" {
  policy_arn = aws_iam_policy.ALBIngressControllerIAMPolicy[0].arn
